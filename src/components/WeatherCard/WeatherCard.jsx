 ...
 const filteredOption = weatherOptions.find(option => {
  ...
  return (
    <section className='weather-card'>
      <p className="weather-card__temperature">{currentTemperatureContext.currentTemperatureUnit === "F" ? weatherData.currentTemp.F : weatherData.currentTemp.C}&deg;{currentTemperatureContext.currentTemperatureUnit === "F" ? "F" : "C"}</p>
